			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card-header">
									<h4 class="mb-0 mt-2 col-3">View Requested Vendor</h4>
								</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
										...
										<table id="order-listing" class="table">
											...
											<tbody>
												...
												<c:forEach items="${vendorList}" var="p" varStatus="j">
													...
													<td><a href="<%=request.getContextPath()%>/documents/vendorDetails/${p.fileName}" target="_blank"><i class="mdi mdi-attachment"
																	style="font-size: 20px; color: #ee4747; margin-left: 15px;"></i></a></td>
														

														<td><a href="acceptVendor?id=${p.id}"><button class="badge badge-success badge-pill">Accept</button></a>
														<a href="rejectVendor?id=${p.id}"><button class="badge badge-danger badge-pill">Reject</button></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
