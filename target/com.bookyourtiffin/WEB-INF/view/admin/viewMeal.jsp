			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card-header">
									<div class="col-1" style="float:right"><a href="addMeal"><button type="button" class="btn btn-primary">Add</button></a></div>
								
								<h4 class="mb-0 mt-2 col-3">View Meal</h4>	
								</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<c:forEach items="${MealList}" var="p" varStatus="j">
												<tr>
														<td>${j.count}</td>
														<td>${p.mealType}</td>
														<td>${p.mealDescription}</td>
												
													<td><a href="editMeal?id=${p.id}"> <i class="mdi mdi-pencil-box"
															style="font-size: 20px; margin-left: 15px;"></i>
													</a><a href="deleteMeal?id=${p.id}"><i class="mdi mdi-delete"
