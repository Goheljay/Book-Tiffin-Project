...
<body class="sidebar-light">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="card-header">
									<h4 class="mb-0 mt-2 col-3">Add Meal</h4>
								</div>
								<div class="card-body">
									...
									<f:form class="cmxform" id="signupForm" onsubmit="return validateTableDetais()" method="post" action="saveMeal"  modelAttribute="mealVO">
										<fieldset>
										
											<div class="form-group">
												<label for="mealname">Meal Type</label> 
													<%-- <f:select path="mealType" class="form-control" id="exampleSelectMeal" >	
															<option >Break Fast</option>
															<option>Lunch</option>
															<option>Dinner</option>
													</f:select> --%>
													<f:input id="mealType" class="form-control" name="mealtype" path="mealType" type="text" />
											</div>
												
											<div class="form-group">
												<label for="mealdescription">Meal Description</label> <f:input
													id="mealDescription" class="form-control" name="mealdescription" path="mealDescription"
													type="text" />
											</div>
	...
	<script
		src="<%=request.getContextPath()%>/adminResources/js/custom/meal.js"></script>
	<!-- End custom js for this page-->
</body>
