			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card-header">
									<h4 class="mb-0 mt-2 col-3">View Blocked Customer</h4>
								</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
											...
											<tbody>
												...
												<c:forEach items="${userList}" var="p" varStatus="j">
													<tr>
														...
														<a href="unblockUser?id=${p.id}"><button class="badge badge-primary badge-pill">Unblock</button></a>
														<a href="deleteUser?id=${p.id}"><i class="mdi mdi-delete"
															style="font-size: 20px; color: #ee4747; margin-left: 15px;"></i></a>
