					...
					<div class="row grid-margin">
						<div class="col-lg-12">
							...
							<div class="card-header">
									<h4 class="mb-0 mt-2 col-3">Add City</h4>
								</div>
								<div class="card-body">
									<%@taglib prefix="f"
										uri="http://www.springframework.org/tags/form"%>

									<f:form class="cmxform" onsubmit="return validateTableDetais()"
										id="commentForm" method="post" action="saveCity"
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<f:input id="cityName" class="form-control" path="cityName"
													name="name" type="text" />
											</div>

											<div class="form-group">
												<label for="ccomment">City Description</label>
												<f:input id="cityDescription" class="form-control"
													path="cityDescription" name="name" type="text" />
											</div>
