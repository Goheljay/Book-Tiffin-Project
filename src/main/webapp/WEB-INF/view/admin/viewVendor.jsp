			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="card-header">
									<h4 class="mb-0 mt-2 col-3">View Active Vendor</h4>
								</div>
						<div class="card-body">
							<div class="row">
								<div class="col-12">
											...
											<tbody>
												...
												<c:forEach items="${vendorList}" var="p" varStatus="j">
													...
													<td><a href="<%=request.getContextPath()%>/documents/vendorDetails/${p.fileName}" target="_blank"><i class="mdi mdi-attachment"
														...
														<td class="pr-0 text-left"><a href="blockVendor?id=${p.id}"><button class="badge badge-primary badge-pill">Block</button></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
